...
function AppContent({ currentTab, setCurrentTab }) {
  ...
  return (
    <div className="min-h-screen bg-game-bg text-game-text bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-800 via-game-bg to-black bg-fixed p-4 md:p-8 font-sans selection:bg-game-accent selection:text-slate-900 overflow-x-hidden">
